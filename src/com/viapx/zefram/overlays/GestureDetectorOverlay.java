 ...
 */
public class GestureDetectorOverlay extends Overlay implements OnGestureListener
{
    /**
     ...
     * @param listener
     */
    public GestureDetectorOverlay(OnGestureListener listener)
    {
        this();
